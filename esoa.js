const monochromeOverride = document.createElement('style');

monochromeOverride.textContent = `
:root {
    --orange-rgb: 255,255,255;
}

/* Force old orange-tinted elements to white */
.peer-wrapper-row,
.top-nav,
.chat-docking-panel,
.container,
.modal-content {
    border-color: rgba(var(--orange-rgb), 0.10) !important;
}

.scroll-nav-btn,
.chat-close-trigger,
.add-btn-circle {
    background: rgba(var(--orange-rgb), 0.05) !important;
    border-color: rgba(var(--orange-rgb), 0.15) !important;
}

.scroll-nav-btn:hover {
    background: rgba(var(--orange-rgb), 0.18) !important;
    border-color: rgba(var(--orange-rgb), 0.35) !important;
}

.list-item {
    background: rgba(var(--orange-rgb), 0.02) !important;
    border-color: rgba(var(--orange-rgb), 0.05) !important;
}

.chat-input-row input,
.modal-content input {
    border-color: rgba(var(--orange-rgb), 0.20) !important;
}

.reaction-pill.user-voted {
...
document.head.appendChild(monochromeOverride);
