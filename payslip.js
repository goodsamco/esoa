...
// ==========================================================================
// Premium Assets Lookup Matrix (Integrated for self-contained background/theme syncing)
    ...
    try {
        ...
        if (accountSnap.exists()) {
            ...
            if (accountData.bgMode === "image") {
                const bgImg = premium3dAssets[accountData.bgValue] || accountData.bgValue;
